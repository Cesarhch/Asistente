...
def configurar_rag(local_path, collection_name, custom_db_directory):
...
def consultar_modelo_local(pregunta):
    ...
    local_path="/Users/cesarhernandez/Documents/PlatformIO/Projects/server_IA/rag/managment/managment.txt"
